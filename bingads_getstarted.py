...
# Required
CLIENT_ID = 'YOUR CLIENT ID HERE FROM THE ACC YOU USE' #opens the window to grant access, this client_id is from the email address signed up
DEVELOPER_TOKEN='DEVELOPER TOKEN PASTE HERE' #does not really change the account_ids taken
ENVIRONMENT='production'
REFRESH_TOKEN="refresh_token.txt"

# Optional
CLIENT_STATE='OPTIONAL TO PASTE IT HERE'
